  ...
  return (
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-12 sm:pt-16 lg:pt-20`}>
        <div className={`rounded-3xl border ${pal.border} ${pal.darkBg} p-7 text-white shadow-[0_18px_52px_rgba(15,35,70,0.16)] sm:p-10 lg:p-14`}>
          ...
          <p className="mt-6 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">{voice.description}</p>
      ...
      <section className={`${dc.shell.section} ${dc.shell.sectionY}`}>
        {posts.length ? (
          ...
          <div className={`${dc.surface.soft} p-8 text-center`}>
            <h2 className="text-3xl font-black tracking-tight">No articles found</h2>
  ...
  return (
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-10 sm:pt-14 lg:pt-16`}>
        <div className={`grid gap-6 rounded-3xl border ${pal.border} bg-white p-6 shadow-[0_18px_52px_rgba(15,35,70,0.08)] lg:grid-cols-[minmax(0,1fr)_320px] lg:p-10`}>
          ...
          <aside className={`min-w-0 rounded-2xl ${pal.darkBg} p-6 text-white`}>
      ...
      <section className="mx-auto w-full max-w-5xl px-4 pb-16 pt-6 sm:px-6 lg:px-8 lg:pb-24">
        <div className={`rounded-3xl border ${pal.border} bg-white p-6 shadow-[0_18px_52px_rgba(15,35,70,0.08)] sm:p-8 lg:p-10`}>
