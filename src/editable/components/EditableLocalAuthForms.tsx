...
const inputClass = 'h-12 rounded-2xl border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#07142b] outline-none transition placeholder:text-slate-400 focus:border-[#315fe8] focus:ring-4 focus:ring-[#315fe8]/10'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-[#315fe8] px-6 text-sm font-black uppercase tracking-[0.14em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
